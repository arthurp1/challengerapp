...
class Ccreate extends Component {
  constructor(props) {
    super(props)
    this.state = { username: '', password: '', date: '', focused: ''}
          ...
          <h3> Post New Challenge </h3>
            ...
            <form className="form">
              <div className="form-group">
                  <input type="text" className="form-control" name="title" placeholder="Challenge title.." onChange={this.onInputChange} value={this.state.username} />
              </div>
              <div className="form-group">
            ...
            <div className="showtime form-group group-inline">
              <div className="input-label">
                ...
                <input className="showdate form-control" name="show-date" type="date" />
                <select className="showtime form-control" name="show-time">
                  <option>09:00</option>
                  <option>10:00</option>
                  <option>11:00</option>
                  <option>12:00</option>
